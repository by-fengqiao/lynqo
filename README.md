...
从 [最新 Release](https://github.com/by-fengqiao/lannook/releases/latest) 下载电脑端安装包。手机和平板直接使用浏览器打开二维码地址，不需要另装客户端。`v26.1.7` 及更早的历史安装包仍保留原来的 LYNQO 文件名；首个 LanNook 发行版会使用下表的新文件名。
